...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        //     ),
        //  );
        BossNames.forEach(function (boss, index) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, aws_amplify_1.API.graphql(aws_amplify_1.graphqlOperation(mutations_1.createRaidBoss, {
                            input: __assign(__assign({}, boss), { id: index })
                        }))];
